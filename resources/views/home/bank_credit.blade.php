...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Bank Credit
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="row" style="min-height: 520px;">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Bank Credit</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{url('bank_credit') }}"  data-parsley-validate>
                        {{ csrf_field() }}
