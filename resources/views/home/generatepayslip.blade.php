...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i>Generate payslip
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Generate payslip</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('generatepayslip') }}">
                        {{ csrf_field() }}
