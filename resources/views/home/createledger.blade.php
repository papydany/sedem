...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Ledger
                            </li>
                        </ol>
                    </div>
                </div>
...
<div class="row" style="min-height: 520px;">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-datey">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('createledger') }}" enctype="multipart/form-data" data-parsley-validate>
                        {{ csrf_field() }}
  ...
  <div class="form-group{{ $errors->has('customer') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="customer" type="text" class="form-control" name="customer" value="{{ old('customer') }}" required>
                         ...
                         <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                          ...
                          <div class="form-group{{ $errors->has('transaction ') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="transaction " type="text" class="form-control" name="transaction" value="{{ old('transaction ') }}" required >
