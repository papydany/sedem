...
@section('content')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> New Asset
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-purchase_datey">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('createasset') }}" enctype="multipart/form-data" data-parsley-validate>
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('asset_name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="asset_name" type="text" class="form-control" name="asset_name" value="{{ old('asset_name') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('cost_of_item') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="cost_of_item" type="text" class="form-control" name="cost_of_item" value="{{ old('cost_of_item') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('manufactured_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                               <input class="date form-control" type="text" name="manufactured_date">
                  ...
                  <div class="form-group{{ $errors->has('depreciation_value') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="depreciation_value" type="text" class="form-control" name="depreciation_value" value="{{ old('depreciation_value') }}" required>
                         ...
                         <div class="form-group{{ $errors->has('salvage_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                               <input class="date form-control" type="text" name="salvage_date">
